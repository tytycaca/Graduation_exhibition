...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, (WCHAR*)L"../GraduationProject v3.0/light_VS.hlsl", (WCHAR*)L"../GraduationProject v3.0/light_PS.hlsl");
	if(!result)
	{
		return false;
	}
										   ...
										   float specularPower)
{
	...
	dataPtr2->pos = D3DXVECTOR3(0.0f, 100.0f, 0.0f);
	dataPtr2->dir = D3DXVECTOR3(0.0f, 0.0f, 1.0f);
	dataPtr2->range = 200.0f;
	dataPtr2->cone = 100.f;
	dataPtr2->att = D3DXVECTOR3(0.4f, 0.02f, 0.000f);
