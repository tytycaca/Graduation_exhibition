...
bool PointLightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, (WCHAR*)L"../GraduationProject v3.0/pointlight_VS.hlsl", (WCHAR*)L"../GraduationProject v3.0/pointlight_PS.hlsl");
	if (!result)
	{
		return false;
	}
...
bool PointLightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
...
bool PointLightShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
