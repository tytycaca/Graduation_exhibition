...
void SkyboxClass::CreateSphere(ID3D11Device* d3d11Device, int LatLines, int LongLines)
{
...
void SkyboxClass::InitializeSkyboxShader(ID3D11Device* d3d11Device)
{
	SKYMAP_VS_Buffer = 0;
	SKYMAP_PS_Buffer = 0;

	hr = D3DX11CompileFromFile(L"SkymapShader.fx", 0, 0, "SKYMAP_VS", "vs_4_0", 0, 0, 0, &SKYMAP_VS_Buffer, 0, 0);
	hr = D3DX11CompileFromFile(L"SkymapShader.fx", 0, 0, "SKYMAP_PS", "ps_4_0", 0, 0, 0, &SKYMAP_PS_Buffer, 0, 0);
